...
<head>
	...
	<title>質問・解答 - YUKINO Lab 公式</title>

    <?php require_once('../page/_shared/link.php'); ?>

    <!-- ページ仕様 -->
    <link rel="stylesheet" href="<?= $sturl ?>style/s/faq.css?<?= time(); ?>">

    <!-- ページスクリプト -->
    <script defer src="<?= $sturl ?>js/s/faq.js?<?= time(); ?>"></script>
</head>
