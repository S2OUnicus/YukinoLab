...
<head>
	...
	<title>About - Yukino Lab 公式</title>

    <?php require_once('../page/_shared/link.php'); ?>

    <!-- ページ仕様 -->
    <link rel="stylesheet" href="<?= $sturl ?>style/s/about.css?<?= time(); ?>">

    <!-- ページスクリプト -->
    <script defer src="<?= $sturl ?>js/s/about.js?<?= time(); ?>"></script>
</head>
<body hx-history-elt hx-ext="head-support">
    ...
    <div id="yl-layers">
        ...
        <div id="yl-ly-stage" class="uk-flex uk-flex-column uk-flex-middle">
            ...
            <!--
            (!! Important !!) Stage Main: [About]
            -->
            <main class="uk-flex uk-flex-column uk-flex-center">
                <?php require_once('inner/_about.php'); ?>
            </main>
